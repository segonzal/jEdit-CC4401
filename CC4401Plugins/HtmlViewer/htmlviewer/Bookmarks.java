...
public class Bookmarks extends AbstractTableModel {
    ...
    public Bookmarks() {
        for (int i=0; ; i++) {
            String title = jEdit.getProperty("htmlviewer.bookmarks.title."+i);
            if (title == null) break;
            String url = jEdit.getProperty("htmlviewer.bookmarks.url."+i);
    ...
    public String getColumnName(int index) {
        String ret = "";
        switch (index) {
            case 0: ret = jEdit.getProperty("htmlviewer.bdialog.col0"); break;
            case 1: ret = jEdit.getProperty("htmlviewer.bdialog.col1"); break;
            default: break;
        }
        return ret;
    }
    ...
    public void save() {
        ...
        while (i < entries.size()) {
            ...
            if (b.getTitle() == null || b.getTitle().length() == 0) {
                ...
                jEdit.setProperty("htmlviewer.bookmarks.title." + count, 
                                  b.getTitle());
                jEdit.setProperty("htmlviewer.bookmarks.url." + count,
                                  b.getURL());
                i++;
                count++;
            }
        }
        jEdit.unsetProperty("htmlviewer.bookmarks.title." + count);
        jEdit.unsetProperty("htmlviewer.bookmarks.url." + count);
    }
